...
<form  method="post" action="">
          ...
          <input type="text" placeholder="Enter the name" name="raw" value="<?php echo $row['name'];?>" />
         ...
         <input type="text" placeholder="Enter the supplier" name="supplier" value="<?php echo $row['supplier'];?>" />
         <label>CONTACT:</label>
         <input type="text" placeholder="Enter the contact" name="contact" value="<?php echo $row['contact'];?>" / >
