...
<form  method="post" action="">
          ...
          <label>NAME:</label>
          <input type="text" placeholder="Enter the name" name="name" value="<?php echo $row['name'];?>" />
         ...
         <input type="text" placeholder="Enter the category" name="cat"  value="<?php echo $row['category'];?>" /> 
